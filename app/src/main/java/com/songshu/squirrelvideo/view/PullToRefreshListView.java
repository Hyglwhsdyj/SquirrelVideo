 ...
 * <br>mIsLoadSuccess(是否加载数据成功，成功为true,失败请在请求数据的失败时设为 false)
 */
public class PullToRefreshListView extends ListView implements OnScrollListener {
    ...
    private final static int ENDINT_AUTO_LOAD_DONE_FULL = 4;
    /**
     * 标记是否已经把数据全部加载完毕  *
     */
    private boolean DATA_LOAD_COMPLETION_FLAG = false;
    /**
     * 标记数据是否加载成功  *
     */
    ...
    public boolean ismIsLoadSuccess() {
        return mIsLoadSuccess;
    }

    public void setmIsLoadSuccess(boolean mIsLoadSuccess) {
    ...
    private void init(Context pContext) {
        setCacheColorHint(pContext.getResources().getColor(R.color.ss_transparent));
    ...
    private void addHeadView() {
        mHeadView = (LinearLayout) mInflater.inflate(R.layout.pulltorefreshlistview_header, null);
        ...
        L.d(TAG + "size", "width:" + mHeadViewWidth + " height:" + mHeadViewHeight);
    ...
    private void addFooterView() {
        mEndRootView = mInflater.inflate(R.layout.pulltorefreshlistview_footer, null);
...
//			endingView.setVisibility(View.VISIBLE);
            ...
            switch (mEndState) {
                ...
                case ENDINT_MANUAL_LOAD_DONE:// 手动刷新完成
                    ...
                    if (mIsLoadSuccess) {
                        ...
                        mEndLoadTipsTextView.setText(R.string.p2refresh_end_load_fail);
                        mIsLoadSuccess = true;
                    }
                    // 点击加载
                    // mEndLoadTipsTextView.setText(R.string.p2refresh_end_click_load_more);
                ...
                case ENDINT_AUTO_LOAD_DONE_FULL:
                    if (DATA_LOAD_COMPLETION_FLAG) {
                        DATA_LOAD_COMPLETION_FLAG = false;
                        mEndLoadTipsTextView.setText(R.string.p2refresh_doing_full);
                        mEndLoadTipsTextView.setVisibility(View.VISIBLE);
                        mEndLoadProgressBar.setVisibility(View.GONE);
                        mEndRootView.setVisibility(View.VISIBLE);
                        mEndRootView.setEnabled(false);
    ...
    private Runnable runnable = new Runnable() {
        @Override
        public void run() {
            mEndLoadTipsTextView.setVisibility(GONE);
        }
    };
     ...
     * @date 2013-11-11 下午10:21:38
     */
    public void onLoadMoreComplete_full() {
        mEndState = ENDINT_AUTO_LOAD_DONE_FULL;
        DATA_LOAD_COMPLETION_FLAG = true;
        changeEndViewByState();
    }
