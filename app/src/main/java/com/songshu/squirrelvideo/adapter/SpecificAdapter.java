 ...
 */
public class SpecificAdapter extends MyBaseAdapter {

    private static final String TAG = SpecificAdapter.class.getSimpleName() + ":";
    private Context mContext;
    private List<VideoBean> dataList = new LinkedList<VideoBean>();

    public SpecificAdapter(Context mContext, List<VideoBean> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = View.inflate(mContext, R.layout.item_specific, null);
        ...
        if ((position * 5) < dataList.size()) {
            ...
            VideoBean bean = dataList.get(position * 5);
        ...
        if ((position * 5 + 1) < dataList.size()) {
            ...
            VideoBean bean = dataList.get(position * 5 + 1);
        ...
        if ((position * 5 + 2) < dataList.size()) {
            ...
            VideoBean bean = dataList.get(position * 5 + 2);
        ...
        if ((position * 5 + 3) < dataList.size()) {
            ...
            VideoBean bean = dataList.get(position * 5 + 3);
        ...
        if ((position * 5 + 4) < dataList.size()) {
            ...
            VideoBean bean = dataList.get(position * 5 + 4);
