 ...
 */
public class MovieRecommAdapter extends MyBaseAdapter {

    private static final String TAG = MovieRecommAdapter.class.getSimpleName() + ":";
    private Context mContext;
    private List<VideoBean> dataList = new LinkedList<VideoBean>();

    public MovieRecommAdapter(Context mContext, List<VideoBean> dataList) {
...
//        dataList.addAll(tempList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ((position * 4) < dataList.size()) {
            ...
            VideoBean bean = dataList.get(position * 4);
        ...
        if ((position * 4 + 1) < dataList.size()) {
            ...
            VideoBean bean = dataList.get(position * 4 + 1);
        ...
        if ((position * 4 + 2) < dataList.size()) {
            ...
            VideoBean bean = dataList.get(position * 4 + 2);
        ...
        if ((position * 4 + 3) < dataList.size()) {
            ...
            VideoBean bean = dataList.get(position * 4 + 3);
